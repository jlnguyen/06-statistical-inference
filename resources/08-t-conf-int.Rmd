...
class(I(relevel(sleep$group, 2)))
sleep$extra ~ I(relevel(sleep$group, 2))
```
...
CI smaller when data assumed to be paired; some variability is explained from the (non-random) pairing.

Assuming no pairing, CI covers 0; i.e. estimated mean extra sleep {(before - after) drug use} of 0 -> no correlation between using drugs and increased sleep (drugs have no effect on helping sleep).
