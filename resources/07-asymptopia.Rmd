...
normal quantile times the SE yields a confidence interval for the mean:
  * Adding and subtracting 2 SEs works for 95% intervals (1.96 for more accuracy)
...
# NOTES Joe | 18 Oct, 2015
- LLN also shows Poisson rates converge to the population rates (rates that Poission rates are estimating) as lambda tends to infinity (in example above, as monitoring time t tends to infinity).
